...
namespace T0yK4T.IO
{
    ...
    public sealed class Packet
    {
        ...
        public byte[] GetBytes()
        {
            ...
            if (this.ChannelID == 0)
                this.ChannelID = T0yK4T.Cryptography.CryptoCommon.GetPrngInt();
            if (this.DestinationUserID == 0)
                this.DestinationUserID = T0yK4T.Cryptography.CryptoCommon.GetPrngInt();
            if (this.SourceUserID == 0)
                this.SourceUserID = T0yK4T.Cryptography.CryptoCommon.GetPrngInt();
